...
data = pdr.get_data_yahoo("AAPL", start=datetime.date.today(), end=datetime.date.today()+datetime.timedelta(days=1))
...
df = pdr.get_data_yahoo("AAPL", start=datetime.date.today(), end=datetime.date.today()+datetime.timedelta(days=1)).reset_index()
